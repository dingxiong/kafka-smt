...
/*
* */
    public static final Schema OBJECT_SCHEMA = SchemaBuilder.struct()
            ...
            .build();
    public static final Schema ASSOCIATION_SCHEMA = SchemaBuilder.struct()
            .name("database-1.admincoin.mutations.Value")
    ...
    public static final Schema OBJECT_COLUMN_INDEX_SCHEMA = SchemaBuilder.struct()
            .name("database-1.admincoin.mutations.Value")
    ...
    public static final Schema OBJECT_TYPE_SCHEMA = SchemaBuilder.struct()
            .name("database-1.admincoin.mutations.Value")
            .field("id", Schema.INT64_SCHEMA)
    ...
    public static final Schema ACCOUNTING_LEDGER_ACCOUNT_BALANCE_SCHEMA = SchemaBuilder.struct()
            .name("database-1.admincoin.mutations.Value")
    ...
    private static final PartitionRouting<SourceRecord> partitionRoutingTransformation = new PartitionRouting<>();
    ...
    public void routeObjectMessages() {
        ...
        final Optional<String> orgGuid = PartitionRouting.getOrganizationGuid((Struct)eventRecord.value());
    ...
    public void routeAssociationMessages() {
        ...
        final SourceRecord eventRecord = buildSourceRecord("association", buildAssociationRow(guid, guid), CREATE);
    ...
    public void routeObjectColumnIndexMessages() {
        final String guid = "8605a5e6-4603-4fd3-803b-0ac3178781bc";
        final SourceRecord eventRecord = buildSourceRecord("object_column_index", buildObjectColumnIndexRow(guid), CREATE);
    ...
    public void routeBreakoutTableMessages() {
        final String guid = "8605a5e6-4603-4fd3-803b-0ac3178781bc";
        final SourceRecord eventRecord = buildSourceRecord("accounting_ledger_account_balance", buildAccountingLedgerAccountBalanceRow(guid), CREATE);
    ...
    private SourceRecord buildSourceRecord(String table, Struct row, Envelope.Operation operation) {
        ...
        Schema valueSchema;
        switch (table) {
            case "object": valueSchema = OBJECT_SCHEMA; break;
            case "association": valueSchema = ASSOCIATION_SCHEMA; break;
            case "object_column_index": valueSchema = OBJECT_COLUMN_INDEX_SCHEMA; break;
            case "object_type": valueSchema = OBJECT_TYPE_SCHEMA; break;
            case "accounting_ledger_account_balance": valueSchema = ACCOUNTING_LEDGER_ACCOUNT_BALANCE_SCHEMA; break;
            default:
